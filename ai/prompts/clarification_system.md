...
- Do NOT include any numbering, prefixes, or list markers inside the question text (for example: "1.", "1)", "Q1:", "-", "•"). Each question must contain only the plain question sentence. 
